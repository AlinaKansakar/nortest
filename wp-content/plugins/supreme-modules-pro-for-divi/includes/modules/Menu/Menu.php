...
class DSM_NavMenu extends ET_Builder_Module {
			...
			'advanced' => array(
				'toggles' => array(
					...
					'submenu_collapse_style' => array(
						'title'    => esc_html__( 'Sub Menu Collapse', 'dsm-supreme-modules-pro-for-divi' ),
						'priority' => 39,
					),
				),
			),
		...
		return array(
			'fonts'          => array(
				...
				'menu'     => array(
					...
					'css'             => array(
						'main'        => '%%order_class%% ul.dsm-menu li a, %%order_class%% ul.dsm-menu-submenu-collapse li a .et-pb-icon',
	...
	public function get_fields() {
		...
		return array(
			...
			'submenu_collapse'               => array(
				'label'            => esc_html__( 'Collapse Sub Menu', 'dsm-supreme-modules-pro-for-divi' ),
				'type'             => 'yes_no_button',
				...
				'toggle_slug'      => 'main_content',
				'description'      => esc_html__( 'Here you can choose whether your submenu should be collapsed.', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'submenu_arrow_color'            => array(
				...
				'type'           => 'color-alpha',
				'description'    => esc_html__( 'Here you can define a custom color for your arrow.', 'dsm-supreme-modules-pro-for-divi' ),
				'tab_slug'       => 'advanced',
				'toggle_slug'    => 'submenu_collapse_style',
				'hover'          => 'tabs',
				'mobile_options' => true,
			...
			'submenu_arrow_gap'              => array(
				'label'           => esc_html__( 'Arrow Gap', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'hover'           => 'tabs',
				'mobile_options'  => true,
			...
			'submenu_arrow_padding'          => array(
				'label'           => esc_html__( 'Arrow Padding', 'dsm-supreme-modules-pro-for-divi' ),
			...
			'submenu_arrow_font_size'        => array(
				'label'            => esc_html__( 'Arrow Font Size', 'dsm-supreme-modules-pro-for-divi' ),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( isset( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && ! empty( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && 'on' === get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) {
			if ( isset( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets_compatibility'] ) && ! empty( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && 'on' === get_option( 'dsm_settings_misc' )['dsm_dynamic_assets_compatibility'] ) {
				wp_enqueue_style( 'dsm-menu', plugin_dir_url( __DIR__ ) . 'Menu/style.css', array(), DSM_PRO_VERSION, 'all' );
			} else {
	...
	public function dsm_load_required_divi_assets( $assets_list, $assets_args, $instance ) {
		...
		// Menu.
		if ( in_array( 'dsm_menu', $all_shortcodes, true ) ) {
