...
if ( ! class_exists( 'El_Blog_Update' ) ) {
	class El_Blog_Update {
		...
		public function __construct() {
			$this->plugin_name			= 'Divi-Blog-Extras';
			$this->plugin_version		= ELICUS_BLOG_VERSION;
			$this->plugin_basename		= ELICUS_BLOG_BASENAME;
	        $this->metadata_url 		= 'http://cdn.elicus.com';
	        $this->upgrade_transient    = 'upgrade_divi_blog_extras';
	        $this->last_checked_option  = 'divi_blog_extras_last_checked';
