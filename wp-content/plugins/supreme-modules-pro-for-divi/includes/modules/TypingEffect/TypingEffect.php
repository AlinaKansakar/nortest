...
class DSM_TypingEffect extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( '' !== $typing_effect ) {
			$typing_effect = sprintf(
				'<%1$s class="dsm-typing-effect et_pb_module_header">%7$s<span class="dsm-typing-wrapper"><span class="dsm-typing-strings">%9$s</span><span class="dsm-typing" data-dsm-typing-strings="%2$s"%3$s%4$s%5$s%6$s%10$s%11$s%12$s></span></span>%8$s</%1$s>',
	...
	public function dsm_load_required_divi_assets( $assets_list, $assets_args, $instance ) {
		...
		// TypingEffect.
		if ( in_array( 'dsm_typing_effect', $all_shortcodes, true ) ) {
