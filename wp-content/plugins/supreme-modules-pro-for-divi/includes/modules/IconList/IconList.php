...
class DSM_Icon_List extends ET_Builder_Module {
	...
	public function get_fields() {
		...
		return array(
			...
			'icon_gap_width'            => array(
				'label'           => esc_html__( 'Icon Gap Width', 'dsm-supreme-modules-pro-for-divi' ),
				'description'     => esc_html__( 'Here you can define a custom gap width for the icon.', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'range',
			...
			'list_layout'             => array(
				...
				'description'     => esc_html__( 'The list layout can be either vertical or horizontal.', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
			...
			'list_direction'          => array(
				...
				'description'     => esc_html__( 'The list direction can be either left-to-right or right-to-left.', 'dsm-supreme-modules-pro-for-divi' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( isset( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && ! empty( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && 'on' === get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) {
			if ( isset( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets_compatibility'] ) && ! empty( get_option( 'dsm_settings_misc' )['dsm_dynamic_assets'] ) && 'on' === get_option( 'dsm_settings_misc' )['dsm_dynamic_assets_compatibility'] ) {
				wp_enqueue_style( 'dsm-icon-list', plugin_dir_url( __DIR__ ) . 'IconList/style.css', array(), DSM_PRO_VERSION, 'all' );
			} else {
	...
	public function dsm_load_required_divi_assets( $assets_list, $assets_args, $instance ) {
		...
		// IconList.
		if ( in_array( 'dsm_icon_list', $all_shortcodes, true ) ) {
