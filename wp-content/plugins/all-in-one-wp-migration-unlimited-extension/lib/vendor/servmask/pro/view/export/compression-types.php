...
<?php if ( ai1wm_has_compression_type( 'gzip' ) || ai1wm_has_compression_type( 'bzip2' ) ) : ?>
	<li><strong><?php esc_html_e( 'Compression Options', AI1WM_PLUGIN_NAME ); ?></strong></li>
	<li>
		<label for="ai1wm-compression-type-none">
			...
			<?php esc_html_e( 'None (Fastest, largest file size)', AI1WM_PLUGIN_NAME ); ?>
		</label>
	</li>
	...
	<?php if ( ai1wm_has_compression_type( 'gzip' ) ) : ?>
		<li>
			<label for="ai1wm-compression-type-gzip">
				...
				<small style="color: red;"><?php esc_html_e( 'new', AI1WM_PLUGIN_NAME ); ?></small>
			</label>
		</li>
	<?php endif; ?>
